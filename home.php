                        ...
                        <div class="row">
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="add_to_cart.php" style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;">Buy Now</a></div>
